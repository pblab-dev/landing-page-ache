...
const eventId = 72767;
const linkCadastro = 'event230321';

const cardioRepList = [
  { nome: '', grupoId: 0 },
  { nome: 'Cesar do Amaral', grupoId: 21075 },
  { nome: 'Luis Eduardo Fragoso', grupoId: 21076 },
  { nome: 'Caroline Dorster', grupoId: 21077 },
  { nome: 'Karla Machado', grupoId: 21078 },
  { nome: 'Victor Rangel', grupoId: 21079 },
  { nome: 'Caroline Pinto', grupoId: 21080 },
  { nome: 'Raqueline Macena', grupoId: 21081 },
  { nome: 'Janaina Carvalho', grupoId: 21082 },
  { nome: 'Flavia Santanna', grupoId: 21083 },
  { nome: 'Luigi Oliveira', grupoId: 21108 },
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      Object.keys(values).forEach((e) => {
        ...
        if (e === 'crm') {
          objValue = { id: 189948, value: values[e] };
        }
        if (e === 'email') {
          _email = values[e];
          objValue = { id: 189564, value: values[e] };
        }
        if (e === 'informacoes') {
          objValue = { id: 189956, value: `${values[e]}` };
        }
        if (e === 'nome') {
          objValue = { id: 189563, value: values[e] };
        }
        if (e === 'representante') {
          objValue = { id: 189949, value: values[e] };
        }
        if (e === 'termoPrivacidade') {
          objValue = { id: 189950, value: `${values[e]}` };
        }
      ...
      if (_token) {
        window.location.href = `https://hall.inteegra.com.br/72767?token=${_token}`;
      } else {
    ...
    <div className="main">
      ...
      {/* <image className="header-logo">
        ...
        <nav className="header-menu">
          ...
          <div className="header-menu-item">
            <a href="https://hall.inteegra.com.br/72767">Entrar</a>
          </div>
          <div style={{ marginTop: '2%' }}>
            <a href=" https://hall.inteegra.com.br/72767">
      ...
      <div className="main-body">
        <div className="form-wrapper">
          <div className="data-event-title">Data: 23/03/2021</div>
          ...
          <div className="form-row">
            <div className="button-wrapper">
              <button
                onClick={() =>
                  (window.location.href = 'https://hall.inteegra.com.br/72767')
                }
              >
                Entrar
              </button>
