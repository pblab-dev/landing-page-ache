...
const eventId = 72766;
const linkCadastro = 'event160321';

const cardioRepList = [
  { nome: '', grupoId: 0 },
  { nome: 'Rafaela Dantas', grupoId: 21069 },
  { nome: 'Vilmar Teodoro', grupoId: 21070 },
  { nome: 'Fernanda Girundi', grupoId: 21071 },
  { nome: 'Sheila Souza', grupoId: 21072 },
  { nome: 'Andreia Resende', grupoId: 21073 },
  { nome: 'Roni Rosa', grupoId: 21074 },
  { nome: 'Luigi Oliveira', grupoId: 21107 },
];
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      Object.keys(values).forEach((e) => {
        if (e === 'areaInteresse') {
          objValue = { id: 189947, value: values[e] };
        }
        if (e === 'crm') {
          objValue = { id: 189943, value: values[e] };
        }
        if (e === 'email') {
          _email = values[e];
          objValue = { id: 189562, value: values[e] };
        }
        if (e === 'informacoes') {
          objValue = { id: 189946, value: `${values[e]}` };
        }
        if (e === 'nome') {
          objValue = { id: 189561, value: values[e] };
        }
        if (e === 'representante') {
          objValue = { id: 189944, value: values[e] };
        }
        if (e === 'termoPrivacidade') {
          objValue = { id: 189945, value: `${values[e]}` };
        }
      ...
      if (_token) {
        window.location.href = `https://hall.inteegra.com.br/72766?token=${_token}`;
      } else {
    ...
    <div className="main">
      ...
      {/* <image className="header-logo">
        ...
        <nav className="header-menu">
          ...
          <div className="header-menu-item">
            <a href="https://hall.inteegra.com.br/72766">Entrar</a>
          </div>
          <div style={{ marginTop: '2%' }}>
            <a href=" https://hall.inteegra.com.br/72766">
      ...
      <div className="main-body">
        <div className="form-wrapper">
          <div className="data-event-title">Data: 16/03/2021</div>
          ...
          <div className="form-row">
            <div className="button-wrapper">
              <button
                onClick={() =>
                  (window.location.href = 'https://hall.inteegra.com.br/72766')
                }
              >
                Entrar
              </button>
