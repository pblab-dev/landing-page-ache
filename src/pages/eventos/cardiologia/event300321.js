...
const linkTermo =
  'https://s3.us-east-1.amazonaws.com/bucket.aws.public/hall_72692/TERMO%20DE%20ACEITE/Template%20Aviso%20de%20Privacidade%20Sandoz%20Talks.pdf';
const eventId = 72768;
const linkCadastro = 'event300321';

const cardioRepList = [
  { nome: '', grupoId: 0 },
  { nome: 'Fabrício Boeira', grupoId: 21084 },
  { nome: 'Luis Zanetta', grupoId: 21085 },
  { nome: 'Altair Silva', grupoId: 21086 },
  { nome: 'Luiz Rhoden', grupoId: 21087 },
  { nome: 'Raquel Rosa da Silva', grupoId: 21088 },
  { nome: 'Rodrigo Rizzo', grupoId: 21089 },
  { nome: 'Luciano Dutra Fernandes', grupoId: 21090 },
  { nome: 'Luis Júnior', grupoId: 21091 },
  { nome: 'Luis Carlos Alves da Silva', grupoId: 21092 },
  { nome: 'Luigi Oliveira', grupoId: 21109 },
...
const validationSchema = yup.object({
  ...
  termoPrivacidade: yup.bool().oneOf([true], 'Termo requerido'),
  informacoes: yup.bool().oneOf([true], 'Termo requerido'),
});
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      Object.keys(values).forEach((e) => {
        if (e === 'areaInteresse') {
          objValue = { id: 189957, value: values[e] };
        }
        if (e === 'crm') {
          objValue = { id: 189953, value: values[e] };
        }
        if (e === 'email') {
          _email = values[e];
          objValue = { id: 189566, value: values[e] };
        }
        if (e === 'informacoes') {
          objValue = { id: 189956, value: `${values[e]}` };
        }
        if (e === 'nome') {
          objValue = { id: 189565, value: values[e] };
        }
        if (e === 'representante') {
          objValue = { id: 189954, value: values[e] };
        }
        if (e === 'termoPrivacidade') {
          objValue = { id: 189955, value: `${values[e]}` };
        }
      ...
      if (_token) {
        window.location.href = `https://hall.inteegra.com.br/72768?token=${_token}`;
      } else {
    ...
    <div className="main">
      ...
      {/* <image className="header-logo">
        ...
        <nav className="header-menu">
          ...
          <div className="header-menu-item">
            <a href="https://hall.inteegra.com.br/72768">Entrar</a>
          </div>
          <div style={{ marginTop: '2%' }}>
            <a href=" https://hall.inteegra.com.br/72768">
      ...
      <div className="main-body">
        <div className="form-wrapper">
          <div className="data-event-title">Data: 30/03/2021</div>
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="term-wrapper">
              ...
              <div className="formik-message-error-term">
                {formik.touched.informacoes && formik.errors.informacoes}
              </div>
            </div>
            <div className="form-row">
          ...
          <div className="form-row">
            <div className="button-wrapper">
              <button
                onClick={() =>
                  (window.location.href = 'https://hall.inteegra.com.br/72768')
                }
              >
                Entrar
              </button>
