...
const eventId = 72851
const linkCadastro = 'event240321'
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      Object.keys(values).forEach((e) => {
        if (e === 'areaInteresse') {
          objValue = { id: 190149, value: values[e] };
        }
        if (e === 'crm') {
          objValue = { id: 190145, value: values[e] };
        }
        if (e === 'email') {
          _email = values[e];
          objValue = { id: 189921, value: values[e] };
        }
        if (e === 'informacoes') {
          objValue = { id: 190148, value: `${values[e]}` };
        }
        if (e === 'nome') {
          objValue = { id: 189920, value: values[e] };
        }
        if (e === 'representante') {
          objValue = { id: 190146, value: values[e] };
        }
        if (e === 'termoPrivacidade') {
          objValue = { id: 190147, value: `${values[e]}` };
        }
    ...
    <div className="main">
      ...
      <div className="main-body">
        <div className="form-wrapper">
          <div className="data-event-title">Data: 24/03/2021</div>
