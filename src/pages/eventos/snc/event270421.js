...
const eventId = 72852
const linkCadastro = 'event270421'
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      Object.keys(values).forEach((e) => {
        if (e === 'areaInteresse') {
          objValue = { id: 190154, value: values[e] };
        }
        if (e === 'crm') {
          objValue = { id: 190150, value: values[e] };
        }
        if (e === 'email') {
          _email = values[e];
          objValue = { id: 189923, value: values[e] };
        }
        if (e === 'informacoes') {
          objValue = { id: 190153, value: `${values[e]}` };
        }
        if (e === 'nome') {
          objValue = { id: 189922, value: values[e] };
        }
        if (e === 'representante') {
          objValue = { id: 190151, value: values[e] };
        }
        if (e === 'termoPrivacidade') {
          objValue = { id: 190152, value: `${values[e]}` };
        }
      ...
      if (_token) {
        window.location.href = `https://hall.inteegra.com.br/${eventId}?token=${_token}`;
      } else {
    ...
    <div className="main">
      ...
      <div className="main-body">
        <div className="form-wrapper">
          <div className="data-event-title">Data: 27/04/2021</div>
          ...
          <div className="form-row">
            <div className="button-wrapper">
              <button
                onClick={() =>
                  (window.location.href = `https://hall.inteegra.com.br/${eventId}`)
                }
              >
                Entrar
              </button>
