...
import '../styles/pageinitialpos0903.css';
...
function PageInitial() {
  ...
  return (
    <div className="main-ini">
      ...
      <div className="main-body-wrapper-pos">
        <div className="main-body-content-pos">
          <p >Bem-vindo(a) ao</p>
          <div className="logo-sandoz-ini">
            <img src={logoIni} alt="logo_sandoz" height="100%" />
          </div>
          <p style={{marginTop: '2%', fontSize: '18px'}}>Escolha sua área de interesse</p>
          <div className="button-wrapper-start">
            <button onClick={() => history.push('/cardiologia')}>
              Cardiologia
            </button>
          </div>
          <div className="button-wrapper-start">
              <button onClick={()=> history.push("/snc")}>SNC</button>
            </div>
        </div>
      </div>
